package net.anumbrella.menusummary.config;
...
public class Config {
     ...
     * 数组的大小为(28)
     */
    public static String[] list = new String[]{"特价", "潮流女装", "品牌男装",
     ...
     * 数组的大小为(28)
     */
    public static int[] iconList = new int[]{R.mipmap.tejia,
            R.mipmap.nvzhuang, R.mipmap.nanzhuang, R.mipmap.nanzhuang,
            R.mipmap.tongzhuang, R.mipmap.dianqi, R.mipmap.dianqi,
            R.mipmap.dianqi, R.mipmap.jiaju, R.mipmap.muying,
            R.mipmap.meishi, R.mipmap.haixian, R.mipmap.jiaju,
            R.mipmap.jiaju, R.mipmap.nvzhuang, R.mipmap.nanzhuang,
            R.mipmap.shipin, R.mipmap.shipin, R.mipmap.zhongbiao,
            R.mipmap.zhongbiao, R.mipmap.shipin, R.mipmap.jiaju,
            R.mipmap.zhongbiao, R.mipmap.dianqi, R.mipmap.zhongbiao,
            R.mipmap.zhongbiao, R.mipmap.zhongbiao, R.mipmap.zhongbiao
    };
    ...
    public static int[] EXPANDABLE_LISTVIEW_IMG = new int[]{
            R.mipmap.ic_category_15, R.mipmap.ic_category_20,
            R.mipmap.ic_category_30, R.mipmap.ic_category_35
    };
